    ...
    return (
        <>
            ...
            <MainWrap>
                ...
                <SubBanner onClick={moveProduct}><img src={sub_banner} alt="" /></SubBanner>
                            ...
                            {goods.map((goods) => {
                                return (
                                    <GoodsList key={goods.productId} onClick={prepare}>
                                        ...
                                        <GoodsText style={{ marginTop: '40px' }}>{goods.title}</GoodsText>
                                        <GoodsText style={{ marginTop: '10px' }}>{goods.price}</GoodsText>
                                    </GoodsList>
                                )
                            })}
                        </SwiperWrap>
...
const MainBannerArrow1 = styled.img`
    cursor: pointer;
    &:hover {
        filter: invert(48%) saturate(3207%) hue-rotate(130deg) brightness(95%) contrast(80%);   
    }
    position: absolute;
    top: 280px;
    left: 40px;
